 ...
 */
ns.setMetricURLs = function(urls) {
 ...
 */
ns.setUpdateInterval = function(interval) {
 ...
 */
ns.getUpdateInterval = function() {
    return updateInterval;
}

/**
 * Set the type of data to pull (json|jsonp)
 * 
 * @param type
 *            Type of data (json|jsonp)
 */
ns.setDataType = function(type) {
 ...
 */
ns.setRequestOptions = function(map) {
    requestOptions = map;
}
 ...
 *            to 100
 */
ns.addGraph = function(placeholder, options, metrics, totalPoints) {
...
// Add test utilities to the namespace
ns._test = {
